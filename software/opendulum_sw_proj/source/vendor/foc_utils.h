 ...
 * @attention
 *
 * This software is taken from the SimpleFOC arduino library, licensed under the MIT license.
 * The license file can be found here: https://github.com/simplefoc/Arduino-FOC/blob/master/LICENSE
 * 
 * This file has been adapted from "src/common/foc_utils.hpp"
 * located in the SimpleFOC Github repo, and can be found 
 * at this link: https://github.com/simplefoc/Arduino-FOC/tree/master
 * 
 * Thanks to everyone who contributed to such an awesome Arduino Library!!
 * 
 *******************************************************************************/
